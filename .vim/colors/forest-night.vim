...
exe 'hi' 'Conceal' 'term=NONE' 'guifg=#fb8965' 'ctermfg=209'
'guibg='.s:bg_gui 'ctermbg=233'
hi Conceal          ctermbg=NONE ctermfg=14    cterm=NONE      guibg=NONE
guifg=#616c72   gui=NONE
hi Conditional term=NONE guifg=#a8d2eb ctermfg=153
hi Constant term=NONE guifg=#fd8489 ctermfg=210
exe 'hi' 'Cursor' 'term=NONE' 'guifg='.s:bg_gui 'ctermfg=233'
'guibg=#fffeeb' 'ctermbg='.s:fg_cterm
hi CursorColumn term=NONE guibg=#4c5866 ctermbg=235
hi CursorLine term=NONE guibg=#4c5866 ctermbg=235 gui=NONE cterm=NONE
hi CursorLineNr term=NONE guifg=#e7d5ff ctermfg=189 guibg=#536273
ctermbg=238
...
exe 'hi' 'Error' 'term=NONE' 'guifg=#fd8489' 'ctermfg=210' 'guibg=#4c5866'
'ctermbg=235' s:bold_attr
exe 'hi' 'ErrorMsg' 'term=NONE' 'guifg=#fd8489' 'ctermfg=210'
'guibg='.s:bg_gui 'ctermbg=233' s:bold_attr
hi Float term=NONE guifg=#fd8489 ctermfg=210
hi FoldColumn       ctermbg=NONE ctermfg=110   cterm=NONE      guibg=NONE
guifg=#7fc1ca   gui=NONE
hi Folded           ctermbg=NONE ctermfg=110   cterm=NONE      guibg=NONE
guifg=#7fc1ca   gui=NONE
hi Function term=NONE guifg=#f0aa8a ctermfg=216
exe 'hi' 'Identifier' 'term=NONE' 'guifg=#fedf81' 'ctermfg=222'
s:italic_attr
hi IncSearch term=NONE guifg=NONE ctermfg=NONE guibg=#a9667a ctermbg=132
...
exe 'hi' 'MatchParen' 'term=NONE' 'guifg='.s:bg_gui 'ctermfg=233'
'guibg=#a9667a' 'ctermbg=132' 'gui=underline cterm=underline'
...
hi Normal           ctermbg=239  ctermfg=229   cterm=NONE      guibg=#3C4C55
guifg=#FFEBC3   gui=NONE
hi Number term=NONE guifg=#fd8489 ctermfg=210
hi Operater term=NONE guifg=#f0aa8a ctermfg=216
hi Pmenu            ctermbg=243  ctermfg=229   cterm=NONE      guibg=#616c72
guifg=#ffebc3   gui=NONE
hi PmenuSbar        ctermbg=243  ctermfg=NONE  cterm=NONE      guibg=#616c72
guifg=NONE      gui=NONE
hi PmenuSel         ctermbg=243  ctermfg=229   cterm=REVERSE   guibg=#616c72
guifg=#ffebc3   gui=REVERSE
hi PmenuThumb       ctermbg=229  ctermfg=NONE  cterm=NONE      guibg=#ffebc3
guifg=NONE      gui=NONE
hi PreProc term=NONE guifg=#f0aa8a ctermfg=216
hi Question term=NONE guifg=#a8d2eb ctermfg=153
hi Search term=NONE guifg=NONE ctermfg=NONE guibg=#605779 ctermbg=60
gui=underline cterm=underline
hi SignColumn       ctermbg=243  ctermfg=NONE  cterm=NONE      guibg=#616c72
guifg=NONE      gui=NONE
exe 'hi' 'Special' 'term=NONE' 'guifg=#f0eaaa' 'ctermfg=229' s:bold_attr
hi SpecialKey term=NONE guifg=#607080 ctermfg=60
exe 'hi' 'SpellBad' 'term=NONE' 'guifg=#fd8489' 'ctermfg=210'
'guisp=#fd8489' s:undercurl_attr
exe 'hi' 'SpellCap' 'term=NONE' 'guifg=#e7d5ff' 'ctermfg=189'
'guisp=#e7d5ff' s:undercurl_attr
exe 'hi' 'SpellLocal' 'term=NONE' 'guifg=#fd8489' 'ctermfg=210'
'guisp=#fd8489' s:undercurl_attr
exe 'hi' 'SpellRare' 'term=NONE' 'guifg=#f0eaaa' 'ctermfg=229'
'guisp=#f0eaaa' s:undercurl_attr
hi Statement term=NONE guifg=#a8d2eb ctermfg=153
exe 'hi' 'StatusLine' 'term=NONE' 'guifg=#fffeeb' 'ctermfg='.s:fg_cterm
'guibg=#536273' 'ctermbg=238' s:bold_attr
hi StatusLineNC term=NONE guifg=#8d9eb2 ctermfg=103 guibg=#4c5866
ctermbg=235 gui=NONE cterm=NONE
exe 'hi' 'StatusLineTerm' 'term=NONE' 'guifg=#fffeeb' 'ctermfg='.s:fg_cterm
'guibg=#536273' 'ctermbg=238' s:bold_attr
hi StatusLineTermNC term=NONE guifg=#8d9eb2 ctermfg=103 guibg=#4c5866
ctermbg=235 gui=NONE cterm=NONE
exe 'hi' 'StorageClass' 'term=NONE' 'guifg=#fedf81' 'ctermfg=222'
s:italic_attr
...
exe 'hi' 'TabLineSel' 'term=NONE' 'guifg=#fedf81' 'ctermfg=222'
'guibg='.s:bg_gui 'ctermbg=233' s:bold_attr
hi Tag term=NONE guifg=#f0aa8a ctermfg=216
exe 'hi' 'Title' 'term=NONE' 'guifg=#fedf81' 'ctermfg=222' s:bold_attr
exe 'hi' 'Todo' 'term=NONE' 'guifg='.s:bg_gui 'ctermfg=233' 'guibg=#fd8489'
'ctermbg=210' s:bold_attr
exe 'hi' 'ToolbarButton' 'term=NONE' 'guifg=#fedf81' 'ctermfg=222'
'guibg='.s:bg_gui 'ctermbg=233' s:bold_attr
hi ToolbarLine term=NONE guifg=#8d9eb2 ctermfg=103 guibg=#536273 ctermbg=238
hi Type term=NONE guifg=#fedf81 ctermfg=222
hi Underlined term=NONE guifg=#a8d2eb ctermfg=153 gui=underline
cterm=underline
hi VertSplit        ctermbg=NONE ctermfg=243   cterm=NONE      guibg=NONE
guifg=#616c72   gui=NONE
...
exe 'hi' 'DiffChange' 'term=NONE' 'guibg='.s:darkgold_gui 'ctermbg=58'
s:bold_attr
exe 'hi' 'DiffDelete' 'term=NONE' 'guifg=#fffeeb' 'ctermfg='.s:fg_cterm
'guibg=#ab6560' 'ctermbg=167' s:bold_attr
...
exe 'hi' 'gitconfigSection' 'term=NONE' 'guifg=#a8d2eb' 'ctermfg=153'
s:bold_attr
...
exe 'hi' 'javaScriptBraces' 'term=NONE' 'guifg=#fffeeb'
'ctermfg='.s:fg_cterm
...
exe 'hi' 'rstEmphasis' 'term=NONE' 'guibg=#4c5866' 'ctermbg=235'
s:italic_attr
exe 'hi' 'rstStrongEmphasis' 'term=NONE' 'guibg=#536273' 'ctermbg=238'
s:bold_attr
...
exe 'hi' 'typescriptBraces' 'term=NONE' 'guifg=#fffeeb'
'ctermfg='.s:fg_cterm
...
exe 'hi' 'wastListDelimiter' 'term=NONE' 'guifg=#fffeeb'
'ctermfg='.s:fg_cterm
...
exe 'hi' 'ALEWarningSign' 'term=NONE' 'guifg=#f0aa8a' 'ctermfg=216'
'guibg=#4c5866' 'ctermbg=235' s:bold_attr
exe 'hi' 'ALEErrorSign' 'term=NONE' 'guifg=#4c5866' 'ctermfg=235'
'guibg=#ab6560' 'ctermbg=167' s:bold_attr
...
exe 'hi' 'CleverFChar' 'term=NONE' 'guifg='.s:bg_gui 'ctermfg=233'
'guibg=#fd8489' 'ctermbg=210'
exe 'hi' 'DirvishArg' 'term=NONE' 'guifg=#f0eaaa' 'ctermfg=229' s:bold_attr
exe 'hi' 'EasyMotionTarget' 'term=NONE' 'guifg=#fd8489' 'ctermfg=210'
s:bold_attr
exe 'hi' 'EasyMotionShade' 'term=NONE' 'guifg=#8d9eb2' 'ctermfg=103'
'guibg='.s:bg_gui 'ctermbg=233'
hi GitGutterAdd term=NONE guifg=#a9dd9d ctermfg=150 guibg=#4c5866
ctermbg=235
hi GitGutterChange term=NONE guifg=#f0eaaa ctermfg=229 guibg=#4c5866
ctermbg=235
hi GitGutterChangeDelete term=NONE guifg=#fedf81 ctermfg=222 guibg=#4c5866
ctermbg=235
hi GitGutterDelete term=NONE guifg=#fd8489 ctermfg=210 guibg=#4c5866
ctermbg=235
hi HighlightedyankRegion term=NONE guibg=#4c5866 ctermbg=235
if s:gui_running
    exe 'hi' 'EasyMotionIncCursor' 'term=NONE' 'guifg='.s:bg_gui
    'ctermfg=233' 'guibg=#fffeeb' 'ctermbg='.s:fg_cterm
else

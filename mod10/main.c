        ...
        switch (menuOp) 
        {
            case 'a':
                ...
                if(headNode == NULL)
                {
                    ...
                    CreatePlaylistNode(headNode, uniqueID, songName, artistName,
                            songLength, NULL);
                }
                else
                {
            ...
            case 'r':
                ...
                // *** Loop to find the one you want ***
                while((k == 0) && (songNode != NULL));
                {
                    if (songNode == NULL) 
                    {
                    ...
                    else 
                    {
                        ...
                        else 
                        {
                            ...
                            // .....
                            // FIX ME                      currNode->nextNodePtr = songNode->nextNodePtr;
                            //
